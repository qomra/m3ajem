1. A word in the text is fully highlighted if it fully matches the targeted word
2. A word in the text is higilighted if it starts with one of the following حروف الجر [ب و ك ف ل] and then the targeted word.. You highlight the entire word including the حرف الجر. We should ignore diacritics from the first letter  in this check.. so وَ is still و 
