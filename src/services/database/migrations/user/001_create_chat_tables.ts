...
/**
 * Migration: Create chat tables (USER DATABASE)
 *
...
export async function up(db: SQLiteDatabase): Promise<void> {
  console.log('Running user migration 001: Create chat tables');
  ...
  console.log('✓ User migration 001 completed: Chat tables created');
}
...
export async function down(db: SQLiteDatabase): Promise<void> {
  console.log('Rolling back user migration 001: Drop chat tables');
  ...
  console.log('✓ User migration 001 rolled back');
}
